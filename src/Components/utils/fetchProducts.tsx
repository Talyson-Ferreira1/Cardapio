...
export async function SearchProduct({ Info_Collection, Info_DocCollection, folderNameImg  }: SearchProps): Promise<ProductProps> {
    ...
    const allImagesOfProducts: imagesProps = await getImagesOfProducts({ infoProducts: allProducts });
